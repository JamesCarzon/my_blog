...
description: |
  ...
  profile investigation. A discussion of the book "Weapons of Math Destruction" 
  by Cathy O'Neil.
author:
  - name: James Carzon 
...
A prudent distinction is to be made between the "rigor" of mathematics and the "fuzziness" of its applications. There is not any real question as to whether arithmetic is "true." It's by logical rules that we all agree to accept as kids that two and two are four, four and four are eight, et cetera. The only way that two and two are not four is if you decide to change the rules, in which case you will be asking a different question. However, of mathematical descriptions of the world, there is almost always some imperfection.

This is to preface a response to what is probably the most immediate criticism of claims to systemic or social inequality caused (in entirety or in part) by "Big Data." You know--numbers and stuff. Math. Science, truth, and facts. But not just any facts. The facts that we find when we study the numbers and stuff that are generated and documented by modern technology at an incredible volume. It certainly seems to me that these data, like any other facts of math or science, have no idea what they are describing. They simply arise in the world naturally. It is not the case that "the number of people in academia who consistently vote for Republicans" might be one of perhaps several entities conspiring to steepen political bias in higher education. It's just a fact of what we (might) observe. So to claim that Big Data are a reason for some sort of inequality of this sort is, obviously, a misunderstanding of what they are.

There are fairly clear examples of negative feedback loops, though. That is, there are ways in which data and their trained algorithms help to widen measurable inequalities. I have written this post in an attempt to clarify this point of confusion from my personal understanding of the phenomenon of data-driven feedback loops.

# Stereotypes arising from data

I would like to be able to chase a claim from some data set to its source and totally and completely understand the story of its generation. That would be the ideal way to "do statistics about the world." This is difficult to do.

For example, maybe I want to know how my online advertisements are determined. As a casual experiment, I jumped onto *The Grad Cafe*, a forum for graduate students from across all of academia, and surveyed the ads I received after a few minutes of browsing: AllState, Hewlett-Packard, Go Daddy, Xfinity and Spectrum, T-Mobile, UWMCareers.com, and the University of Connecticut Pharmacy School. Why do you think I am getting these ads in particular?

On the one hand, my personal browsing history would suggest that I have spent time recently thinking about insurance and the internet and building websites, et cetera. These are topics that I've undoubtedly binge-Binged before. It is plausible that I am shown ads which, among those bought by companies around the internet, were determined to be most interesting to me by some algorithm.

On the other hand, I am a user on *The Grad Cafe* after all and, as such, fit into the demographic of people interested in graduate school. Like many of my peers on the site, I'm in my early '20s and I have a college degree. I'm from the United States. I have the time and resources to browse the internet freely and at length. People like me tend to be interested in things like academic careers, pharmacy schools, and cloud computing. It is plausible that I am shown ads which, among those bought by companies around the internet, were determined to be most interesting to us users of *The Grad Cafe*.
...
Over time, Google has inferred these interests of mine from my activity indirectly. I've been stereotyped, simply put. As long as the algorithm satisfies me, I reinforce the stereotype. In this example, my stereotype is largely benign, but hopefully it is clear that the concept at work can be translated to different contexts. Stereotypes of all kinds are like algorithms. They efficiently approximate the data that we collect, but with that efficiency comes a compromise in accuracy. When we make efficient approximations of someone's behavior, for example, based on the groups to which they belong, we lose information about their individual peculiarities. This claim, I think, is clear enough.

What is the value of a stereotype? If this is a purely sociological question, then it's difficult to answer it as a statistician. The threats of "Big Data" are well noted, though. Cathy O'Neil's book Weapons of Math Destruction furnishes a collection of serious examples of algorithms which are the products of the attitude that squeezing meaning out of Big Data is the way of the future for sociological problems.

```{r, fig.align='center'}
knitr::include_graphics("img/weapons_of_math_destruction.jpg")
```

For example, one might look at university rankings to decide to which colleges they should apply, but there is nothing "true" about the University of Virginia being a better place to study than the University of Florida. Maybe if you asked a billion people which one is better, then you can bet that they will favor Virginia in a mass, but that's not corresponding to any facts of the universe! The <em>US News</em> staff doesn't count the goodness particles floating in the Gainesville sky and weigh its ranking on that metric. Yet it's easier for us to steamroll ahead with decisions informed by numbers than to perform a cost-benefit analysis with even less complete data; it's also easier for university administrators to invest in those features of their university which are relevant to their ranking than to make personal judgment calls on what needs to be fixed. (Of course, I am now indulging in an oversimplification of both of these processes.)
...
Secondly, it allows for centralized authority. For example, if schoolteachers' efficacy can be judged by exam scores, then one person with a computer can decide who in a district should be fired by crunching the exam data set and ignoring the unmeasurable facts. To let all decisions like these be made algorithmically is to decide from the outset that the truth of a judgment is less important than the specificity of it. When authority is centralized, these facts may be lost. So, enabling (and ennobling) algorithms with negative feedback loops of this kind for the purpose of increasing efficiency invites division and ignores local and individual economic peculiarities.
